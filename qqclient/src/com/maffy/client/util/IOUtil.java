...
//  数字+m：1加粗；3斜体；4下划线
    ...
    private static void print(String content, int color, int bgColor) {
        System.out.format("\33[%d;%d;1m%s\33[0m ", color, bgColor, content);
    }
    ...
    public static void printSystemMessage(String content) {
        System.out.format("\33[33;41;1m系统 @你\33[0m %n");
        System.out.println("\t" + content);
    }
}
